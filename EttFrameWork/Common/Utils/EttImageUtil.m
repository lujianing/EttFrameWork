...
+ (UIImage *)imageCompressForSize:(UIImage *)img max:(CGFloat)max_value
{
    ...
    if (imageHeight > imageWidth) {
        ratio = imageHeight/max_value;
        
        if (imageHeight > max_value) {
        ...
        ratio = imageWidth/max_value;
        
        if (imageWidth > max_value) {
            targetWidth = imageWidth/ratio;
            targetHeight = imageHeight/ratio;
        }else {
            targetHeight = imageHeight;
    ...
    NSData *imgData = UIImageJPEGRepresentation(scaledImage, 1);
