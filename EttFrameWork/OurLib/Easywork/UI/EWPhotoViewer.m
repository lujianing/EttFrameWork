...
- (void)showImage:(UIImage *)image imageURL:(NSString *)imageURL isShow:(BOOL)isShow block:(SelectBlock)block
{
    ...
    if (isShow) {
        ...
        [selectButton setImage:[UIImage imageNamed:@"act_allow_n"] forState:UIControlStateNormal];
        [selectButton setImage:[UIImage imageNamed:@"act_allow_h"] forState:UIControlStateSelected];
